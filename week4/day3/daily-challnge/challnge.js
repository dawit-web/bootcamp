...
let getCarHonda = function(carInventory) {
	const firstHondaIndex = carInventory.findIndex((elem, index) => carInventory[index].car_make === "Honda");
	const firstHonda = carInventory[firstHondaIndex];

	return description = `This is a ${firstHonda.car_make} ${firstHonda.car_model} from ${firstHonda.car_year}`;
};
...
let sortCarInventoryByYear = function(carInventory) {
